#takes samtools bedcov output and calculates average coverage per ORF and assigns each ORG a KEGG orthology number.
...
for line in dictfile:
	...
	seqname = columns[0]
	#print seqname
	database = columns[2].rstrip('\n')
	Ddb[seqname] = database
	#print Ddb
	
#make an outfile
outfile = open(str(bedcovfile.replace('_ORF_coverage.txt', '_ORF_coverage_calculated_and_annotated_KO.txt')), 'w')
