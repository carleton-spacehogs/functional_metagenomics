#takes samtools bedcov output and calculates average coverage per ORF and assigns each ORG a COG number.
...
#make an outfile
outfile = open(str(bedcovfile.replace('_ORF_coverage.txt', '_ORF_coverage_calculated_and_annotated_COG.txt')), 'w')
